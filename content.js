...
;(function () {
  var S = [
    ...
    { section: "Over time", fields: [
      ...
      { key: "overtime.s1.title", label: "Step 1 — title", en: "Week one — Softness you can feel", ar: "الأسبوع الأول — نعومة تحسّيها" },
    ...
    { section: "Ingredients / science", fields: [
      { key: "science.eyebrow", label: "Eyebrow", en: "18 ingredients", ar: "١٨ مكوّن" },
      { key: "science.heading", label: "Heading", en: "Softness that holds through the week.", ar: "نعومة تفضل طول الأسبوع." },
      { key: "science.body", label: "Paragraph (each line breaks)", multiline: true, en: "18 carefully curated ingredients, each chosen with a purpose.\nA balanced blend designed to deeply hydrate, soften and smooth the hair.\nHelps reduce frizz, dryness and breakage for softer, easier-to-manage strands.", ar: "١٨ مكوّن مختارين بعناية، كل واحد ليه هدف.\nتركيبة متوازنة معمولة عشان ترطّب الشعر بعمق وتنعّمه وتفرده.\nبتساعد في تقليل الهيشان والجفاف والتقصّف، لشعر أنعم وأسهل في التحكم." },
      { key: "ing.mango.name", label: "Card 1 — name", en: "Mango Butter", ar: "زبدة المانجو" },
      { key: "ing.mango.desc", label: "Card 1 — text", multiline: true, en: "Rich botanical nourishment that helps replenish dry strands and restore a silky, supple feel.", ar: "تغذية نباتية غنية بتساعد على تعويض الشعر الجاف واستعادة ملمس حريري ناعم." },
      { key: "ing.flax.name", label: "Card 2 — name", en: "Flaxseed", ar: "بذور الكتان" },
      { key: "ing.flax.desc", label: "Card 2 — text", multiline: true, en: "Helps lock in moisture, smooth the hair, and leave every strand feeling soft and manageable.", ar: "بيساعد على حبس الترطيب وتنعيم الشعر وترك كل شعرة ناعمة وسهلة في التسريح." },
      { key: "ing.hibiscus.name", label: "Card 3 — name", en: "Hibiscus", ar: "الكركديه" },
      { key: "ing.hibiscus.desc", label: "Card 3 — text", multiline: true, en: "Naturally helps nourish, soften and enhance the hair’s natural shine.", ar: "بيغذّي الشعر وينعّمه ويزوّد لمعانه الطبيعي." },
      { key: "ing.b5.name", label: "Card 4 — name", en: "Pro-Vitamin B5", ar: "بروفيتامين ب5" },
      { key: "ing.b5.desc", label: "Card 4 — text", multiline: true, en: "Deeply hydrates for smooth, silky hair.", ar: "بيرطّب بعمق لشعر ناعم وحريري." },
      { key: "ing.e.name", label: "Card 5 — name", en: "Vitamin E", ar: "فيتامين هـ" },
      { key: "ing.e.desc", label: "Card 5 — text", multiline: true, en: "Antioxidant care for healthy-looking, radiant hair.", ar: "عناية مضادة للأكسدة لشعر صحي ولامع." },
    ]},
